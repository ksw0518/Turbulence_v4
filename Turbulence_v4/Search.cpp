...
int RFP_MULTIPLIER = 87;
int RFP_IMPROVING_MULTIPLIER = 59;
int RFP_BASE = -39;
int RFP_IMPROVING_BASE = -36;
...
int PVS_NOISY_MULTIPLIER = 17;

int HISTORY_BASE = 126;
int HISTORY_MULTIPLIER = 93;
int CONTHIST_BASE = 4;
int CONTHIST_MULTIPLIER = 3;

int ASP_WINDOW_INITIAL = 24;
int ASP_WINDOW_MAX = 308;

int PAWN_CORRHIST_MULTIPLIER = 170;// divide by 5 later
...
int HISTORY_PRUNING_MULTIPLIER = 1331;
int HISTORY_PRUNING_BASE = 59;
int HISTORY_LMR_MULTIPLIER = 772;
int HISTORY_LMR_BASE = 87;
int NMP_EVAL_DIVISER = 408;
